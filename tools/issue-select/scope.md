...
(I have experience with Python, Java, Javascript, SQL, C and C++ along with tools and framworks such as Git, Github, Flask, React, REST APIs, and Docker. I also have experience working with AI concepts and applications such as LLMs, RAG, prompt engineering and AI agents. I am comfortable with software development fundamentals and debugging, and I want to strengthen my Python, AI engineering and open source development skills through this course. I am especially interested in beginner to intermediate issues involving Python, AI applications, APIs, data processing, testing or documentation and I would prefer to avoid issues that require highly specialized low level systems knowledge.)